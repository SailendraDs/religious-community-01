...
class SettingsController extends Controller
{
    ...
    public function joinRequestsApprove($id,Request $request){
        ...
        if($group->owner_id == Auth::user()->id){
            ...
            $notification->message = "Your request to join the group ".$group->name." is approved.";
            $notification->save();
    ...
    public function joinRequestsReject($id,Request $request){
        ...
        if($group->owner_id == Auth::user()->id){
            ...
            $notification = new Notification;
            $notification->user_id = $member->user->id;
            $notification->message = "Your request to join the group ".$group->name." is rejected.";
            $notification->save();
    ...
    public function postApprovalApprove($id,Request $request){
        ...
        if($group->owner_id == Auth::user()->id){
            ...
            $notification = new Notification;
            $notification->user_id = $member->user->id;
            $notification->message = "Your post in the group ".$group->name." is approved.";
            $notification->save();
    ...
    public function postApprovalReject($id,Request $request){
        ...
        if($group->owner_id == Auth::user()->id){
            ...
            $notification = new Notification;
            $notification->user_id = $member->user->id;
            $notification->message = "Your post in the group ".$group->name." is rejected.";
            $notification->save();
